...
namespace XBatteryStatus
{
    ...
    public static class Localization
    {
        ...
        private static readonly (string key, string en, string zh, string ru, string es, string pt, string de, string ja, string fr, string pl, string ko, string ar)[] Table =
        {
            ...
            ("StatusBattery", "XBatteryStatus: {0}", "XBatteryStatus：{0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}", "XBatteryStatus: {0}"),
